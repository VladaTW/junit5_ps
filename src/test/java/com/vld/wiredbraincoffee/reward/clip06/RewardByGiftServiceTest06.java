package com.vld.wiredbraincoffee.reward.clip06;

import com.vld.wiredbraincoffee.product.Product;
import com.vld.wiredbraincoffee.reward.RewardByGiftService;
...
@Disabled("Optimization not implenebted yet")
public class RewardByGiftServiceTest06 {
