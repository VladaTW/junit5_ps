package com.vld.wiredbraincoffee.reward.clip07;

import com.vld.wiredbraincoffee.product.Product;
import com.vld.wiredbraincoffee.reward.RewardByConversionService;
import com.vld.wiredbraincoffee.reward.RewardInformation;
...
public class RewardByConversionServiceTest {
    ...
    void setUp() {
        ...
        assumeTrue("vlajs".equals(System.getenv("GAZDA")));
    }
    ...
    void emptyOrderEnoughPoints() {
        ...
        assertEquals(0, info.getDiscount());
        System.out.println("\n##############################################################\n");
        System.out.println(System.getenv("GAZDA"));
        System.out.println("\n##############################################################\n");
//        assumeTrue("1".equals(System.getenv("TEST_POINTS")));

//        assumeTrue((System.getenv("TEST_POINTS") != null));
        assertEquals(0, info.getPointsRedeemed());
    }
